...
export function createFiberRoot(
  ...
  // stateNode is any.
  console.log('createFiberRoot内还会创建一个HostRootFiber，FiberRoot.current会指向这个HostRootFiber，FiberRoot.current是当前页面的虚拟DOM，在页面更新时候FiberRoot会切换current为完成Diff算法的fiber以达到页面更新；第一个fiber对象，mode决定了fiber树的模式')
