...
export function createEventListenerWrapperWithPriority(
  ...
  if(log === 0) {
    ...
    console.log('主要有三种优先级，从高到低分别是DiscreteEventPriority，ContinuousEventPriority，DefaultEventPriority',DiscreteEventPriority,ContinuousEventPriority,DefaultEventPriority)
    console.log('像鼠标点击，键盘输入等被列为最高优先级，像鼠标移动，滚动鼠标等被列为第二优先级，这三种优先级对应着不同的listener')
    console.log(`当触发这三种listener时候本质都会调用dispatchEvent，不同的是除了默认优先级，
